...
if (empty($_SESSION['logged_in']) || empty($_SESSION['restaurant_id']) || empty($_SESSION['user_id'])) {
...
<div class="container mt-4">
    <h3 class="text-center text-success mb-3">
        <?= htmlspecialchars($_SESSION['restaurant_name'] ?? 'Restaurant') ?> - Purchase Entry
    </h3>
