<?php
// SuperAdmin/mark_credit.php - FINAL VERSION (payment_method fixed for VARCHAR)
session_start();
...
try {
    ...
    $stmt->bind_param(
        ...
        $restaurant_id,
        $order_id,
        $paid_today,                    // amount = only what was paid today
        $discount,
        $transaction_payment_method,    // 'cash', 'online', or 'credit'
        $notes,
        $bs_datetime,
        $_SESSION['username'],
        $user_id,
