...
// Fetch only unreviewed suggestions
$suggestions = $conn->query("SELECT * FROM suggestions WHERE reviewed=0 ORDER BY submitted_at DESC");
?>
...
<div class="container mt-4">
    ...
    <?php else: ?>
        <div class="alert alert-info">No unreviewed suggestions found.</div>
    <?php endif; ?>
</div>
...
<div id="floatConfirm">
    <div style="display:flex; justify-content:space-between; align-items:center;">
        <p style="margin:0;">Mark this suggestion as solved?</p>
...
$('#confirmSolve').click(function() {
    $.post('mark_solved.php', { id: selectedId, type: 'suggestion' }, function(data) {
        if (data.success) {
